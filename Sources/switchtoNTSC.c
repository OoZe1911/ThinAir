...
int main()
{
	...
	fputc((char)7,fileRip);
	fseek(fileRip,16419,SEEK_SET);
	fputc((char)174,fileRip);
	...
	fputc((char)5,fileRip);
	fseek(fileRip,16671,SEEK_SET);
	fputc((char)118,fileRip);
	...
	fputc((char)7,fileLoader);
	fseek(fileLoader,50735,SEEK_SET);
	fputc((char)174,fileLoader);
	...
	fputc((char)5,fileLoader);
	fseek(fileLoader,50987,SEEK_SET);
	fputc((char)118,fileLoader);
